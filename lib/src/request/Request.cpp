...
void Request::refreshOAuth2TokenIfNeeded() {
    if (this->accessToken.empty() || (!this->refreshToken.empty() && this->expires != system_clock::time_point(0s) &&
...
void Request::setProxy(const std::string &proxyUrl, const std::string &proxyUser, const std::string &proxyPassword) {
