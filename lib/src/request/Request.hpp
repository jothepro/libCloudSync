...
class Request {
  public:
    ...
    // MARK: - new interface
    enum ParameterType { HEADERS, QUERY_PARAMS, POSTFIELDS, MIME_POSTFIELDS, MIME_POSTFILES };
    enum ConfigurationOption { VERBOSE, FOLLOW_REDIRECT };
    ...
    virtual void setOAuth2(
        ...
        std::chrono::system_clock::time_point expires = std::chrono::system_clock::time_point(std::chrono::seconds(0)));
